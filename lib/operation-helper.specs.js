...
describe('OperationHelper', function () {
    ...
    describe('#getQueueSize', () => {
      ...
      context('throttling, but with an empty queue', () => {
        before(() => {
          opHelper = new OperationHelper({
              awsId: 'testAwsId',
              awsSecret: 'testAwsSecret',
      ...
      context('throttling with completed queue', () => {
        before(() => {
          opHelper = new OperationHelper({
              awsId: 'testAwsId',
              awsSecret: 'testAwsSecret',
      ...
      context('throttling with an item being executed, and another in the queue', () => {
        before(() => {
          opHelper = new OperationHelper({
              awsId: 'testAwsId',
              awsSecret: 'testAwsSecret',
