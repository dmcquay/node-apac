...
class OperationHelper {
    constructor(params) {
        ...
        this.proxy_username = params.proxy_username
        this.proxy_password = params.proxy_password
        this.proxy_hostname = params.proxy_hostname
        this.proxy_port = params.proxy_port || 8080
    ...
    _execute(operation, params, callback) {
        ...
        if (this.proxy_hostname) {
            ...
            if (this.proxy_username) {
                var auth = 'Basic ' + new Buffer(this.proxy_username + ':' + this.proxy_password).toString('base64')
